...
#finding student's most common color
mostfav= Student.values.group_by { |e| e }.values.max_by(&:size)
print "The most popular color is " ;puts mostfav[0][:color]

#finding student's most common color
# leastfav= Student.values.group_by { |e| e }.values.min_by(&:size)
# print "The least popular color is " ;puts leastfav.to_s
...
for i in 1...Name.length
	puts Name[i][0].split(" ").map { |word| word.capitalize }.join(" ")
end
